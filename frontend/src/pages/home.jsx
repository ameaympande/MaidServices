    ...
    <>
          ...
          <div className="flex flex-wrap items-center">
            <div className="ml-auto mr-auto w-full px-4 text-center lg:w-8/12">
              <Typography
                variant="h2"
                color="white"
                className="mb-6 font-black text-2xl lg:text-4xl"
              >
              ...
              <Typography
                variant="lead"
                color="white"
                className="opacity-80 text-sm lg:text-base"
              >
      ...
      <section className="-mt-32 bg-white px-4 pb-20 pt-4 bg-[url('/img/bgsection.jpg')] bg-cover bg-center">
        <div className="container mx-auto">
          ...
          <div className="mt-32">
            <div className="mx-auto w-full px-4 md:w-10/12 text-center">
              <Typography
                variant="h6"
                className="mb-3 font-bold text-lg md:text-xl"
                color="blue"
              >
              ...
              <Typography
                variant="h2"
                className="mt-4 mb-8 font-bold text-lg md:text-2xl"
              >
                Hire Professionals, Experienced Specifically for Your Needs
              </Typography>
            </div>

            <div className="mx-auto mt-8 flex flex-wrap justify-center gap-4 md:gap-8">
